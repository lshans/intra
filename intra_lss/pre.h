...
struct block predict_4_parameter(short block_image[10][10], short resi[4][4], short block_pre[4][4], int i_row, int i_col, block blocktab[][COLS], int mode_block);

//struct block predict_1_parameter(short block_image[10][10], short resi[4][4], short block_pre[4][4], int i_row, int i_col, block blocktab[][COLS]);
//struct block predict_2_parameter(short block_image[10][10], short resi[4][4], short block_pre[4][4], int i_row, int i_col, block blocktab[][COLS]);
//struct block predict_3_parameter(short block_image[10][10], short resi[4][4], short block_pre[4][4], int i_row, int i_col, block blocktab[][COLS]);
//struct block predict_4_parameter(short block_image[10][10], short resi[4][4], short block_pre[4][4], int i_row, int i_col, block blocktab[][COLS]);
