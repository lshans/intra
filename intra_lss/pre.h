...
long long predict_1_parameter(short block_image[8][8], short resi[4][4], short block_pre[4][4]);
long long predict_2_parameter(short block_image[8][8], short resi[4][4], short block_pre[4][4]);
long long predict_3_parameter(short block_image[8][8], short resi[4][4], short block_pre[4][4], int i_row, int i_col);
long long predict_4_parameter(short block_image[8][8], short resi[4][4], short block_pre[4][4]);
