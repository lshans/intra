...
struct block predict_1_parameter(short block_image[8][8], short resi[4][4], short block_pre[4][4], int i_row, int i_col, block blocktab[][256]);
struct block predict_2_parameter(short block_image[8][8], short resi[4][4], short block_pre[4][4], int i_row, int i_col, block blocktab[][256]);
struct block predict_3_parameter(short block_image[8][8], short resi[4][4], short block_pre[4][4], int i_row, int i_col, block blocktab[][256]);
struct block predict_4_parameter(short block_image[8][8], short resi[4][4], short block_pre[4][4], int i_row, int i_col, block blocktab[][256]);
